...
async fn main() -> Result<(), IndexerError> {
    ...
    let opts = match OldIndexerConfig::from_arg_matches_mut(
                ...
                Command::Indexer {
                    ingestion_config: IngestionConfig {
                        sources: IngestionSources {
                            ...
                            rpc_client_url: Some(rpc_client_url),
                        },
        ...
        Err(_) => iota_indexer::config::IndexerConfig::parse(),
    };
