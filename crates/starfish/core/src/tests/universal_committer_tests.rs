...
async fn test_byzantine_direct_commit() {
    ...
    let certifying_block_a14 = VerifiedBlock::new_for_test(
        TestBlock::new(14, 0)
    ...
    let certifying_block_b14 = VerifiedBlock::new_for_test(
        TestBlock::new(14, 1)
            .set_ancestors(
    ...
    let certifying_block_c14 = VerifiedBlock::new_for_test(
        TestBlock::new(14, 2)
            .set_ancestors(
                good_references_voting_round_for_round_12_without_c13
                    .iter()
    ...
    let certifying_block_d14 = VerifiedBlock::new_for_test(
        TestBlock::new(14, 3)
            .set_ancestors(
                good_references_voting_round_for_round_12_without_c13
                    .iter()
