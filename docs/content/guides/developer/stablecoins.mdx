...
## How to transfer USDC on IOTA {#usdc-guide}
...
Here's a quickstart guide for developers to build an app to perform their first USDC transfer on IOTA.

### Contract addresses

- [Testnet](https://iotascan.xyz/testnet/coin/0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC)
  ```
  0xa1ec7fc00a6f40db9693ad1415d0c193ad3906494428cf252621037bd7117e29::usdc::USDC
  ```
- [Mainnet](https://iotascan.xyz/coin/0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC)
  ```
...
- [IOTA Wallet](https://chromewebstore.google.com/detail/iota-wallet/opcgpfmipidbgpenhmajoajpbobppdil): Install the IOTA Wallet browser extension, set up your wallet, and connect it to the appropriate network. Ensure that your wallet is funded with:
  - Some IOTA tokens to cover transaction fees. (**Request Testnet IOTA Tokens** from the **Wallet Settings** page)
...
Install IOTA dependencies next:
...
1. Click the **Request Testnet IOTA Tokens** button from your IOTA Wallet to source gas tokens. The button is visible only when your wallet is connected to Testnet.
